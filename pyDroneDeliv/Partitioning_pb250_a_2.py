...
problem_g.import_csv('pb250_a.csv')
...
pro.clarke_and_wright(problem2, param1, version="parallel", name="Drone1 - Partition")
pro.clarke_and_wright(problem1, param2, version="parallel", name="Drone2 - Partition")

init_1 = pro.clarke_and_wright_init(problem2, param1)
init_2 = pro.clarke_and_wright_init(problem1, param2)
deliveries_1 = pro.parallel_build_deliveries(problem2, param1, *init_1)
deliveries_2 = pro.parallel_build_deliveries(problem1, param2, *init_2)
